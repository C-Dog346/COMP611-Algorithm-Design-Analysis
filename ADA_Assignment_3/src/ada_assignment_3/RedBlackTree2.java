...
public class RedBlackTree2 extends BinarySearchTree {
    ...
    /**
     * Exception thrown by {@link #blackHeight} if the black-height of a node is
     * ill-defined.
     */
    ...
    /**
     * Inner class for a red-black tree node. Extends a binary search tree node
     * with an additional color field.
     */
    protected class Node extends BinarySearchTree.BinaryTreeNode {
        ...
        /**
         * Initializes a node with the data, makes other pointers nil, and makes
         * the node red.
         *
        ...
        /**
         * Returns the <code>data</code> instance variable of this node and this
         * node's color as a <code>String</code>.
         */
    ...
    /**
     * Performs a left rotation on a node, making the node's right child its
     * parent.
     *
     * @param x The node.
     */
    ...
    /**
     * Performs a right rotation on a node, making the node's left child its
     * parent.
     *
     * @param x The node.
     */
     ...
     * @throws DeleteSentinelException if there is an attempt to delete the
     * sentinel <code>nil</code>.
     * @throws ClassCastException if <code>node</code> does not reference a
     ...
     *
     * @param z The node.
     * @throws BlackHeightException if the number of black nodes on a path from
     * the left child down to a leaf differs from the number of black nodes on a
     * path from the right child down to a leaf.
     */
    ...
    /**
     * Returns the number of black nodes from the root down to any leaf. The
     * value should be the same for all paths.
     *
     * @param z The node.
     * @throws BlackHeightException if the number of black nodes on a path from
